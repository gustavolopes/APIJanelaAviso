...
//Declaracao de constates globais
	 		...
	 		try {
	        	...
	        	switch(strNomeTipoAtualJanelaAviso) {
		        	...
		        	case cstTipoConfirmJanelaAviso:
						objJanelaAviso.innerHTML = "<iframe frameborder='0' allowtransparency='true' id='janelaAvisoIframeSobreposicao" + cstTipoConfirmJanelaAviso + "' style='width:" + this.fltLarguraJanelaAviso + cstSufixoPixelJanelaAviso + "; height:" + this.fltAlturaJanelaAviso + cstSufixoPixelJanelaAviso + ";'></iframe>" +
		        	...
		        	case cstTipoJanelaJanelaAviso:
						objJanelaAviso.innerHTML = "<iframe frameborder='0' allowtransparency='true' id='janelaAvisoIframeSobreposicao" + cstTipoJanelaJanelaAviso + "' style='width:" + this.fltLarguraJanelaAviso + cstSufixoPixelJanelaAviso + "; height:" + this.fltAlturaJanelaAviso + cstSufixoPixelJanelaAviso + ";'></iframe>" +
		        	...
		        	default:
						objJanelaAviso.innerHTML = "<iframe frameborder='0' allowtransparency='true' id='janelaAvisoIframeSobreposicao' style='width:" + this.fltLarguraJanelaAviso + cstSufixoPixelJanelaAviso + "; height:" + this.fltAlturaJanelaAviso + cstSufixoPixelJanelaAviso + ";'></iframe>" +
	...
	try {
		...
		if(!document.getElementById("divModalJanelaAviso")) {
			...
			if(document.all) {
				...
				objBloqueiaPagina.style.opacity = "0.5";
		   		objBloqueiaPagina.style.position = "fixed!important"; //Estilo respons�vel pela fixa��o do fundo em Mozilla FireFox
		   	}
		   	//objBloqueiaPagina.innerHTML = "<iframe allowtransparency='true' src='" + strCaminhoPadraoArquivosFontesJanelaAviso + "JanelaAvisoPaginaIframeCorFundo.html' frameborder='0' id='modalIframeSobreposicao' width='100%' height='100%'></iframe>";
		}
		else {
